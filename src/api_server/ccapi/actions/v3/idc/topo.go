...
func init() {
	...
	// register actions
	actions.RegisterNewAction(actions.Action{Verb: common.HTTPSelectGet, Path: "/idc/model/{owner_id}", Params: nil, Handler: topo.SelectTopoModel, Version: v3.APIVersion})
	actions.RegisterNewAction(actions.Action{Verb: common.HTTPSelectGet, Path: "/idc/model/{owner_id}/{cls_id}/{obj_id}", Params: nil, Handler: topo.SelectTopoModelByClsID, Version: v3.APIVersion})
	actions.RegisterNewAction(actions.Action{Verb: common.HTTPSelectGet, Path: "/idc/inst/{owner_id}/{app_id}", Params: nil, Handler: topo.SelectTopoInst, Version: v3.APIVersion})
	actions.RegisterNewAction(actions.Action{Verb: common.HTTPSelectGet, Path: "/idc/inst/child/{owner_id}/{obj_id}/{app_id}/{inst_id}", Params: nil, Handler: topo.SelectTopoInstChild, Version: v3.APIVersion})
...
func (cli *topoAction) SelectTopoModel(req *restful.Request, resp *restful.Response) {
	...
	senceCLI := api.NewClient(topo.CC.IdcAPI())
	cli.CallResponse(
...
func (cli *topoAction) SelectTopoModelByClsID(req *restful.Request, resp *restful.Response) {
	...
	senceCLI := api.NewClient(topo.CC.IdcAPI())
	cli.CallResponse(
		senceCLI.ReForwardSelectMetaIdcTopoByClsID(func(url, method string) (string, error) {
			return httpclient.ReqForward(req, url, method)
		}, ownerID, clsID, objID),
		resp)
...
func (cli *topoAction) SelectTopoInst(req *restful.Request, resp *restful.Response) {
	...
	cli.CallResponse(
		senceCLI.ReForwardSelectMetaIdcTopoInst(func(url, method string) (string, error) {
...
func (cli *topoAction) SelectTopoInstChild(req *restful.Request, resp *restful.Response) {
	...
	senceCLI := api.NewClient(topo.CC.IdcAPI())
	cli.CallResponse(
		senceCLI.ReForwardSelectMetaIdcTopoInstChild(func(url, method string) (string, error) {
			return httpclient.ReqForward(req, url, method)
