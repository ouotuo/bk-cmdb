...
func HostRow() []*metadata.ObjectAttDes {
	...
	dataRows := []*metadata.ObjectAttDes{
		...
		//agent 没有分组
		&metadata.ObjectAttDes{ObjectID: objID, PropertyID: "create_time", PropertyName: "录入时间", IsRequired: false, IsOnly: false, Editable: false, PropertyGroup: mCommon.groupBaseInfo, PropertyType: common.FiledTypeTime, Option: ""},
