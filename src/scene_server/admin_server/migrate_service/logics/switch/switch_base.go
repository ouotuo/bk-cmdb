...
type migrateIdcBase struct {
	tableName string
}

// createTable create table
func (m *migrateIdcBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateIdcBase{tableName: "cc_SwitchBase"}
