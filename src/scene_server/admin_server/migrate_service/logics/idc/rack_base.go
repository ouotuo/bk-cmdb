...
type migrateRackBase struct {
	tableName string
}

// createTable create table
func (m *migrateRackBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	mModule := &migrateRackBase{tableName: "cc_RackBase"}
	migrateregister.RegisterMigrateAction(mModule.createTable, migrateregister.MigrateTypeCreateTable)
}
