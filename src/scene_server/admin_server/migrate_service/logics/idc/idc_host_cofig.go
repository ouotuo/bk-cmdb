...
type migrateIdcHostConfig struct {
	tableName string
}

// createTable create table
func (m *migrateIdcHostConfig) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateIdcHostConfig{tableName: "cc_IdcHostConfig"}
