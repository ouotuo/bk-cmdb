...
type migratePosBase struct {
	tableName string
}

// createTable create table
func (m *migratePosBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	mSet := &migratePosBase{tableName: "cc_PosBase"}
	migrateregister.RegisterMigrateAction(mSet.createTable, migrateregister.MigrateTypeCreateTable)
}
