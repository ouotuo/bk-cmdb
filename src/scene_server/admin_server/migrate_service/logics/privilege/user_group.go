...
type migrateUserGroup struct {
	tableName string
}

// createTable create table
func (m *migrateUserGroup) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateUserGroup{tableName: "cc_UserGroup"}
