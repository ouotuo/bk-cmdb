...
var tables = map[string][]storage.Index{
	...
	"cc_RackBase": []storage.Index{
		storage.Index{Name: "", Columns: []string{"bk_rack_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_rack_name"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_idc_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
	},
	"cc_PosBase": []storage.Index{
		storage.Index{Name: "", Columns: []string{"bk_pos_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_pos_name"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_idc_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_rack_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
	},
	"cc_IdcHostConfig": []storage.Index{
		storage.Index{Name: "", Columns: []string{"bk_idc_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_host_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_rack_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
		storage.Index{Name: "", Columns: []string{"bk_pos_id"}, Type: storage.INDEX_TYPE_BACKGROUP},
	},
	"cc_SwitchBase": []storage.Index{
