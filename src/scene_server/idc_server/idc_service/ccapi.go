...
import (
	...
	confCenter "configcenter/src/scene_server/idc_server/idc_service/config"
	"configcenter/src/scene_server/idc_server/idc_service/manager"
	"configcenter/src/scene_server/idc_server/idc_service/rdiscover"
...
func (ccAPI *CCAPIServer) InitHttpServ() error {
	a := api.NewAPIResource()
	ccAPI.httpServ.RegisterWebServer("/idc/{version}", rdapi.AllGlobalFilter(), a.Actions)
	// MetricServer
	conf := metric.Config{
		ModuleName:    types.CC_MODULE_IDC,
